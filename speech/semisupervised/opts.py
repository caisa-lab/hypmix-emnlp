...
def parse():
    ...
    parser.add_argument('--partial', action='store_true', help='Add scale and gain augmentation')
    parser.add_argument('--nPartial', type=int, default=10)
    parser.add_argument('--nUnsuper', type=int, default=50)
    # Testing settings
